...
combined = readRDS("Data/data_combined_SoupX_Sampled_0622.RDS")
...
saveRDS(combined, "Data/data_combined_SoupX_Annotated_0623.RDS")
combined = readRDS("Data/data_combined_SoupX_Annotated_0623.RDS")
...
# ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### 
# ### Final Annotation
# combined = readRDS("Data/data_combined_SoupX_Annotated_0511.RDS")
...
# 
# saveRDS(combined, "Data/data_combined_SoupX_Annotated_final.RDS")
# ggsave(last_plot(), file = "Seurat_integrate_SoupX_Annotated_Final.pdf", width = 6, height = 5)
# 
